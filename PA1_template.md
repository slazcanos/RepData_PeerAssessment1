...
<!-- Wed Jan 24 11:44:38 2024 -->
<table border=1>
<tr> <th>  </th> <th> day </th> <th> daily_mean </th> <th> daily_median </th>  </tr>
...
```
## [1] "The interval with max value is 835 with  206.169811320755  average steps"
```
## Imputing missing values
Analyzing NA values in dataset ...

```
## [1] "There are  2304 NA's in all the dataset"
```

```
## [1] "and  2304  rows with NA values"
```

```
## [1] "all NA values in steps variable"
```
